...
//                Toast.makeText(getActivity(), "" + mlistBuy.get(0).getNumberAmount(), Toast.LENGTH_SHORT).show();
    ...
    public void setdata() {
        ...
        productEntity4.setName("ComBo 2");
        productEntity4.setCost("35");
        productEntity4.setImg("https://images.foody.vn/res/g2/15658/prof/s576x330/foody-upload-api-foody-mobile-jhjhjh-190612135623.jpg");
        ProductEntity productEntity5 = new ProductEntity();
        productEntity5.setName("HamBerGer Bò");
        productEntity5.setCost("7");
        productEntity5.setImg("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSfbF3uAVCZXxDoBcindfYg89JS6P-YM_O2vTh_ZxJSJ43e1SIKJQ");
        ProductEntity productEntity6 = new ProductEntity();
        productEntity6.setName("Supper Comb0");
        productEntity6.setCost("50");
        productEntity6.setImg("https://www.yum.com/wps/wcm/connect/yumbrands/37ba42de-a439-4593-a1fe-89930df10aca/investors-menu.jpg?MOD=AJPERES&CACHEID=ROOTWORKSPACE.Z18_2Q82H202O02550QCJUO2J60000-37ba42de-a439-4593-a1fe-89930df10aca-mCn7meW");
        ProductEntity productEntity7 = new ProductEntity();
        productEntity7.setName("Pepsi");
        productEntity7.setCost("1");
        productEntity7.setImg("https://i.pinimg.com/originals/15/55/85/155585f25f86e05594133267ee34dd3f.jpg");
        ...
        mlistProductEntity.add(productEntity6);
        mlistProductEntity.add(productEntity7);
    }
